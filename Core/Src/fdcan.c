...
void MX_FDCAN1_Init(void)
{
  ...
  canFilterConfig.FilterID1 = 0x140;
  canFilterConfig.FilterID2 = 0x140;
  HAL_FDCAN_ConfigFilter(&hfdcan1, &canFilterConfig);

  HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_RX_FIFO0_NEW_MESSAGE, 0);
  TxHeader.Identifier          = 0x140;                  // ID estándar
  TxHeader.IdType              = FDCAN_STANDARD_ID;       // Equivalente a CAN_ID_STD
  TxHeader.TxFrameType         = FDCAN_DATA_FRAME;        // Equivalente a CAN_RTR_DATA
  TxHeader.DataLength          = FDCAN_DLC_BYTES_8;       // DLC = 8 bytes
  TxHeader.ErrorStateIndicator = FDCAN_ESI_ACTIVE;
  TxHeader.BitRateSwitch       = FDCAN_BRS_OFF;           // CAN clásico, sin bitrate flexible
  TxHeader.FDFormat            = FDCAN_CLASSIC_CAN;       // Desactivar CAN FD
